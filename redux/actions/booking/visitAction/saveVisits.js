...
import {FETCH_VISITS_FAILURE, FETCH_VISITS_SUCCESS} from "../../../reducers/booking/visitReducer/visits";
import { SAVE_VISITS_SUCCESS} from "../../../reducers/booking/visitReducer/saveVisits";
import {
  SET_EDIT_VISIT_COPY,
  UPDATE, CREATE, DELETE, ADD_EDIT_VISIT_ROW
} from "../../../reducers/booking/visitReducer/editVisit";
