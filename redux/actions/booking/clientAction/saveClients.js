...
import {FETCH_CLIENTS_SUCCESS} from "../../../reducers/booking/clientReducer/clients";
import { SAVE_CLIENTS_SUCCESS} from "../../../reducers/booking/clientReducer/saveClients";
import {SET_EDIT_CLIENT_COPY,
  UPDATE, CREATE, DELETE
} from "../../../reducers/booking/clientReducer/editClient";
import {SET_READ_ONLY} from "../../../reducers/ecommerce/ux";
import {normalize} from "normalizr";
import {arrayOfClient} from "../../../../schemas";
import {FETCH_SERVICES_FAILURE} from "../../../reducers/booking/serviceReducer/services";
