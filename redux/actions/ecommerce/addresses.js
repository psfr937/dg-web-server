...
import {SAVE_ADDRESS_REQUESTING, SAVE_ADDRESS_SUCCESS, SAVE_ADDRESS_FAILURE} from "../../reducers/ecommerce/address/saveAddress";
import { FETCH_ADDRESSES_SUCCESS, FETCH_ADDRESSES_FAILURE,
  FETCH_ADDRESSES_REQUESTING} from "../../reducers/ecommerce/address/addresses";
import addressAPI from "../../../api/ecommerce/address";
...
import {GET_BUY_QUOTATION} from "./quotation";
import {
  GET_BUY_QUOTATION_FAILURE,
  GET_BUY_QUOTATION_REQUESTING,
  GET_BUY_QUOTATION_SUCCESS
} from "../../reducers/ecommerce/address/getBuyQuotation";
import quotationAPI from "../../../api/ecommerce/quotation";
