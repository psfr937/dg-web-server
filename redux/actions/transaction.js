...
} from "../reducers/transaction/buy";

import {
  SELL_FAILURE,
  SELL_INVALID,
  SELL_REQUESTING, SELL_SUCCESS
} from "../reducers/transaction/sell";
...
import {
  ...
  ADD_PM_INVALID,
  ADD_PM_SUCCESS
} from "../reducers/transaction/addPm";

export const BUY = 'BUY';
export const SELL = 'SELL';
export const ADD_PM = 'ADD_PM';

import transactionAPI from "../../api/tranasaction";
import router from "next/dist/client/router";
import {GET_BUY_QUOTATION_SUCCESS} from "../reducers/address/getBuyQuotation";
