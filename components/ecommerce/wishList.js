...
export default function WishList({editable = true}){

  const dispatch = useDispatch();
  const cids = useSelector(state => state.wishItemDetail);
  ...
  const removeCartItem = (id) => {
    console.log(id)
    dispatch({type: REMOVE_WISH_ITEM, id: id});
  }
